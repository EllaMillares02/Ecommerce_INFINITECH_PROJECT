            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('save_blog') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label>Title</label>
                            <input type="text" name="title" class="form-control"placeholder="Write a Title here..."  required>
                        </div>
                        <div class="mb-3">
                            <label>SubTitle</label>
                            <input type="text" name="subtitle" class="form-control" placeholder="Write a Subtitle here..." required>
                        </div>
                        <div class="mb-3">
                            <label>Content</label>
                            <textarea name="content" rows="15" cols="121" placeholder="Write a content here..." ></textarea>
                        </div>
                        <div class="mb-3">
                            <label>Image</label>
                        ...
                        <button type="submit" class="btn btn-success text-white addbtn">Add Blog</button>
                    </form>
                </div>
            </div>
